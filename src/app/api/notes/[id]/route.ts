...
export async function GET(_request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    return NextResponse.json({ message: "Failed to fetch note" }, { status });
  }
}
...
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const status = isAxiosError(error) ? (error.response?.status ?? 500) : 500;
    return NextResponse.json({ message: "Failed to update note" }, { status });
  }
}
...
export async function DELETE(_request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const status = isAxiosError(error) ? (error.response?.status ?? 500) : 500;
    return NextResponse.json({ message: "Failed to delete note" }, { status });
  }
}
